...
int killthr = false;                                                                                // Valeur d'appel de terminaison 
...
int main () {
    ...
    addrClient.sin_addr.s_addr = inet_addr("127.0.0.1");                                            // IP du serveur                                        [INDIQUER L'IP DU SERVEUR ICI DANS LES ENTRE CÔTES]
